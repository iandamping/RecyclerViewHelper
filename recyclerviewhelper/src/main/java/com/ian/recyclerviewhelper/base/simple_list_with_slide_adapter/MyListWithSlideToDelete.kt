...
import com.ian.recyclerviewhelper.R
 ...
 */
class MyListWithSlideToDelete(context: Context, private val blocks:()-> Unit= {}): ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
